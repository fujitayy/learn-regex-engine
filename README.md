...
- ここは都合の良い他の資料を参照する
  - 時短の為
- どうしても良い資料が無い場合は作る
- 正規表現とオートマトンが一致するのでオートマトンが受理状態になればマッチしたという事になるって話
  - ここでは正規表現とNFAとDFAの同じ事を表現できるという結果だけ利用
    - 従って正規表現がマッチするかどうかは等価なオートマトンが受理状態になるかという問題に言い換えられる
- 正規表現 -> オートマトンへのコンパイル -> オートマトンの実行、の3ステップ
